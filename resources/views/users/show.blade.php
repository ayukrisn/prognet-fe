        ...
        <div class="p-3 py-1">
            ...
            <div class="row mt-2">
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" name="birthdate" class="form-control"
                        value="{{ $user->birthdate }}" placeholder="Birthdate" readonly>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <select name="gender" class="form-control" disabled>
                        ...
                        <option value="Mental Illness"
                            {{ $user->gender === 'Mental Illness' ? 'selected' : '' }}>Mental Illness
                        </option>
                    </select>
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col">
                    ...
                    <img src="{{ asset('storage/foto/' . $user->foto) }}" class="rounded-circle" alt="Profile Picture"
